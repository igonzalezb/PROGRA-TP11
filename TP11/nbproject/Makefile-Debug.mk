...
${OBJECTDIR}/emu_ports.o: emu_ports.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/emu_ports.o emu_ports.c
...
${OBJECTDIR}/input_control.o: input_control.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/input_control.o input_control.c
